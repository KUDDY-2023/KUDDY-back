...
import com.kuddy.common.notification.calendar.dto.KakaoToken;
...
public class KakaoCalendarService {
    ...
    // 카카오 일반 일정 생성
    public void createKakaoEvent(Member member, Meetup meetup, Spot spot) throws JsonProcessingException {
        String kakaoAccessToken = verifyAndRefreshKakaoToken(member.getEmail());
        ObjectMapper objectMapper = new ObjectMapper();
        String kakaoEventString = objectMapper.writeValueAsString(KakaoEvent.from(meetup, spot));
        ...
        ResponseEntity<String> response = wc.post()
                ...
                .onStatus(HttpStatus::is4xxClientError, clientResponse -> {
                    ...
                    return Mono.error(new KakaoCalendarAPIPermissionException());
                })
