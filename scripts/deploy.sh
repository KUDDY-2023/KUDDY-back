...
ABSDIR=/home/ubuntu/kuddy-back/scripts # 현재 디렉토리 위치 /kuddy-back/scripts
#SOURCE_REPOSITORY=$(dirname $ABSDIR) # 부모 디렉토리 위치 /kuddy-back
SOURCE_REPOSITORY=/home/ubuntu/kuddy-back
DOCKER_APP_NAME=kuddy-server # DOCKER_APP_NAME에는 프로젝트명을 적는다.
