...
import com.kuddy.chatserver.chat.interceptor.StompHandler;
...
public class WebSocketConfiguration implements WebSocketMessageBrokerConfigurer {
	...
	public void configureMessageBroker(MessageBrokerRegistry registry) {
		registry.enableSimpleBroker("/topic/"); // /topic/{chatNo}로 주제 구독 가능
		registry.setApplicationDestinationPrefixes("/app"); // /app/message로 메시지 전송 컨트롤러 라우팅 가능
	}
